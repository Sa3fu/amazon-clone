...
function Header() {
  return (
    <div className=" h-16 flex items-center justify-between bg-[#131921] sticky top-0 z-10 w-full">
      {/* Amazon Icon */}
      ...
      <div className="flex pr-2">
        <div className="flex gap-2 justify-between w-full hover:border border-white cursor-pointer rounded-sm px-3 py-1">
          <div className="flex h-10">
            ...
            <span className=" rounded-full bg-red-500 p-0.5 mb-4 px-2 text-sm text-red-50">
              4
            </span>
          </div>
        </div>
