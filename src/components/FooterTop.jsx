    ...
    <div className=" w-full bg-white py-6">
      <div className="w-full border-t-[1px] border-b-[1px] py-8">
        <div className="w-64 mx-auto text-center flex flex-col gap-1">
          ...
          <button className="w-full bg-gradient-to-b from-yellow-400 to-yellow-200 rounded-md py-1 font-semibold hover:bg-yellow-500 active:bg-yellow-700">Sign in</button>
